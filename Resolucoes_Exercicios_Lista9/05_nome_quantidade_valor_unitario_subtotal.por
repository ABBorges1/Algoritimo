programa
{
	...
	real valor_produto[11], sub_total[11], cc2
	funcao inicio()
	{
		caracter c = ' '
		faca
 ...
 * 
 * @POSICAO-CURSOR = 1592; 
 * @DOBRAMENTO-CODIGO = [19, 34, 43, 56, 77, 84];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {cc, 6, 26, 2}-{digitos, 6, 34, 7}-{qtd_digitos, 6, 47, 11}-{x, 80, 16, 1};
